...
const TransactionMenu = ({dailyTransactions, currentDay, handleAddTransactionForm, onSelectTransaction, isMobile, open, onClose}: TransactionProps) => {
    ...
    >
      <Stack sx={{ height: "100%" }} spacing={2}>
        ...
        >
          ...
          {/* 右側の追加ボタン */}
          <Button startIcon={<AddCircleIcon />} onClick={handleAddTransactionForm} color="primary">
            内訳を追加
          </Button>
        </Box>
        {/* 取引一覧 */}
